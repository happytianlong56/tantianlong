...
<?php  include("leftmenu.php");?>	  	
		  ...
		  <div class="content">
			...
			<div class="control-group">
			    ...
			    <div class="controls">
			      <input type="text" name="biaoti" value="<?php echo $arrClass['标题'];?>" class="input-large input-fat" placeholder="输入栏目名称" data-rules="required|minlength=2">
			    </div>
			  </div>
			  <!-- 肩题 -->
			  <div class="control-group">
			    ...
			    <div class="controls">
			      <input type="text" name="jianti" value="<?php echo $arrClass['肩题'];?>" class="input-large input-fat" placeholder="输入栏目名称" data-rules="required|minlength=2">
			    </div>
			  </div>
			  	<!-- 栏目 -->
			<div class="control-group">
