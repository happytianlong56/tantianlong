...
function renderData(data){
	  ...
	  $.each(data.data,function(key,value){
	  	...
	  	str+="<td><a class='sui-btn btn-samll btn-warning' href='news-edit.php?kid="+value.id+"'>修改</a>&nbsp;&nbsp;<a class='sui-btn btn-samll btn-danger' href='api5.php?action=news_del&kid="+value.id+"'>删除</a></td>";
	  	str += "</tr>";
