		  ...
		  <div class="content">
			...
			<form id="form1" action="student-update.php" class="sui-form form-horizontal sui-validate" enctype="multipart/form-data" method="post" >
			  <div class="control-group">
			    ...
			    <div class="controls">
			      <input type="text" name="st_xuehao" value="<?php echo $arrClass['学号'];?>"  class="input-large input-fat" placeholder="输入课程名称" data-rules="required|minlength=2|maxlength=15" >
			    </div>
			  </div>
			  <div class="control-group">
